...
-- 2. Suppression de toutes les anciennes tables (et vues homonymes eventuelles)
...
-- Table 5 : Journee (Periodes de la journee pour les routines)
CREATE TABLE journee (
    id INT AUTO_INCREMENT PRIMARY KEY,
    libelle VARCHAR(50) NOT NULL
);

-- Table 6 : Regles Automatiques (Seuils d'Alerte pour Ressources et Plantes)
...
-- Table 7 : Routines Quotidiennes (Actions programmees selon la periode)
...
-- Table 8 : Historique des mesures des capteurs
...
-- ========================================================
-- INSERTION DES DONNEES D'ORIGINE DU PROJET
-- ========================================================
...
(3, 'Sommeil / Reserve O2', 'sommeil', 98.00, 100.00, '%', 'ROUGE');
...
-- 4. Journee (Periodes de la journee)
...
-- 5. Regles Automatiques (Seuils d'alerte)
...
-- 6. Routines Quotidiennes (planning heures fixes reveil/repas/hydratation/sommeil)
...
(4, 3, NULL, 3, '07:00:00', 'Reveil - LED rouge (sommeil)', TRUE),
...
(4, 3, NULL, 3, '23:00:00', 'Dormir - LED rouge (sommeil)', TRUE);

-- 7. Historique des releves (Logs)
